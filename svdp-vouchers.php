...
require_once SVDP_VOUCHERS_PLUGIN_DIR . 'includes/interfaces/interface-delivery-method.php';
require_once SVDP_VOUCHERS_PLUGIN_DIR . 'includes/interfaces/interface-delivery-provider.php';
require_once SVDP_VOUCHERS_PLUGIN_DIR . 'includes/class-delivery-method-registry.php';
...
require_once SVDP_VOUCHERS_PLUGIN_DIR . 'includes/class-voucher-delivery-view.php';
