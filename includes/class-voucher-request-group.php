    ...
    private static function insert_requested_lines($voucher_id, $voucher_type, $snapshots) {
        ...
        foreach ($snapshots as $snapshot) {
            ...
            $result = $wpdb->insert($table, [
                ...
                'requested_pricing_type_snapshot' => $snapshot['requested_pricing_type_snapshot'] ?? null,
                'requested_price_min_snapshot' => $snapshot['requested_price_min_snapshot'] ?? null,
                'requested_price_max_snapshot' => $snapshot['requested_price_max_snapshot'] ?? null,
                'requested_price_fixed_snapshot' => $snapshot['requested_price_fixed_snapshot'] ?? null,
                'show_price_as_max_snapshot' => isset($snapshot['show_price_as_max_snapshot']) ? (int) $snapshot['show_price_as_max_snapshot'] : null,
                'discount_type_snapshot' => $snapshot['discount_type_snapshot'] ?? null,
                'discount_value_snapshot' => $snapshot['discount_value_snapshot'] ?? null,
                'quantity_max_snapshot' => isset($snapshot['quantity_max_snapshot']) ? (int) $snapshot['quantity_max_snapshot'] : null,
                'selected_category_limit_snapshot' => isset($snapshot['selected_category_limit_snapshot']) ? (int) $snapshot['selected_category_limit_snapshot'] : null,
                'voucher_quantity_max_snapshot' => isset($snapshot['voucher_quantity_max_snapshot']) ? (int) $snapshot['voucher_quantity_max_snapshot'] : null,
